...
class SystemLogViewer(QWidget):
    ...
    def __init__(self):
        ...
        for tag in ["ALL", "BROADCAST", "HANDSHAKE", "INFO", "WARN", "ERROR", "DEBUG"]: # <--- TODO: FIX FOR MAIN APP
            editor = QTextEdit()
...
class CalibrationWidget(QWidget):
    ...
    def build_ui(self):
        ...
        port_layout.addRow("Broadcast Port:", self.comm_port)
...
class CarConnectWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        icon = QIcon()
        icon.addFile(u"D-14/Client-Side/client-app/icons/solar--link-bold-duotone.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
