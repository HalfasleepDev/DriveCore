...
class FloorDetector(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("DriveCore – Floor/Open Space Detection/Path Detection V2")
        ...
        # Margin sliders (Qt.Horizontal by default)
        ...
        # Set default values
        self.h_margin_slider.setValue(25)
        self.s_margin_slider.setValue(60)
        self.v_margin_slider.setValue(40)
    ...
    def update_frame(self):
        ...
        frame = cv2.resize(frame, (640, 480))   # TODO: The frame needs to be resized for the main app
