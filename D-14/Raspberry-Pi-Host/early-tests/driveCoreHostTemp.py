...
'''TODO:
- create return to center function for servo
- create LEFTUP, LEFTDOWN, RIGHTUP, RIGHTDOWN
- modify acceleration speeds/steps
- modify steering speeds/steps
...
def move_servo(command):
    ...
    if command == "RIGHT" and current_servo_pw > MIN_DUTY_SERVO:
        current_servo_pw -= STEP_SERVO
    elif command == "LEFT" and current_servo_pw < MAX_DUTY_SERVO:
        current_servo_pw += STEP_SERVO
